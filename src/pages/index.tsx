...
export default function Home() {
  ...
  return (
    <div className='max-w-[120rem] mx-auto min-h-[1rem] '>
      ...
      {toggle ? (
        <table className=' w-[90%] mx-auto bg-yellow-300 border-[3px] border-black'>
          <thead>
            <tr>
              <th>Sr</th>
              <th>Name</th>
                ...
                return (
                  <tr key={i} className='text-center border-[1px] border-black'>
                    ...
                    <td className='flex justify-around'>
                      <AiOutlineEdit data-te-toggle="tooltip" title='Edit' />
                      <AiOutlineArrowUp data-te-toggle="tooltip" title='Up' />
                      <AiOutlineArrowDown data-te-toggle="tooltip" title='Down' />
                      <RiDeleteBinFill onClick={() => { handleDel(i) }} data-te-toggle="tooltip" title='Delete' />
                    </td>
                  </tr>
                );
              })
